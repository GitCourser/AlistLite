...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "Alist Lite", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "### 精简版\nhttps://github.com/GitCourser/AlistLite", Type: conf.TypeText, Group: model.SITE},
	...
	"epub": {
		"EPUB.js":"https://res.oplist.org/static/epub.js/viewer.html?url=$e_url"
	}
